...
export default function Correcteur() {
  ...
  const models = [
    ...
    { id: 'gemini-3.1-pro-preview', name: 'Gemini 3.1 Pro (Puissant)', icon: '🧠' },
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col gap-6 bg-slate-50/50 rounded-3xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-xl flex flex-col overflow-hidden group focus-within:ring-4 focus-within:ring-primary/10 transition-all h-[492px]">
