    ...
    <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col gap-6 bg-slate-50/50 rounded-2xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {platformConfigs.map((platform) => (
                <motion.div 
                  ...
                  className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 hover:border-primary/50 transition-colors"
                >
          ...
          <div className="flex gap-2">
            ...
            <div className="bg-secondary p-6 rounded-2xl shadow-2xl border border-secondary flex flex-col h-[350px] text-white">
