      ...
      <div className="max-w-6xl mx-auto">
        ...
        <header className="mb-12 flex flex-col md:flex-row md:items-center justify-between gap-4 relative">
          <div className="flex-1">
            <h1 className="text-4xl font-black tracking-tight text-secondary uppercase">Score de visibilité sociale enrichie</h1>
            <p className="text-slate-500 mt-2 font-medium">Développé par la cellule de veille Maarc Watch</p>
          </div>
          <div className="flex items-center gap-6">
            <div className="flex items-center justify-center h-16">
              <img src={logo} alt="Médiapilote" className="h-full object-contain" referrerPolicy="no-referrer" />
            </div>
          </div>
        </header>
