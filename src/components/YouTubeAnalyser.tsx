...
export default function YouTubeAnalyser() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const prompt = `Analyse les commentaires suivants de cette vidéo YouTube "${videoData.title}". 
      ...
      const analysisText = response.text || "Désolé, l'analyse a échoué.";
      ...
      {videoData ? (
        <>
          <div className="grid grid-cols-1 lg:grid-cols-10 gap-6 items-stretch">
            ...
            <div className="lg:col-span-4 bg-white rounded-3xl shadow-xl p-8 border border-slate-200 flex flex-col h-[600px]">
            ...
            <div className="lg:col-span-6 bg-white rounded-3xl shadow-xl border border-slate-200 flex flex-col h-[600px] overflow-hidden">
                ...
                <AnimatePresence>
                  {(analysis || analyzing) && (
                    <motion.div 
                      ...
                      className="bg-[#FBC33C] rounded-xl overflow-hidden shadow-sm mb-2"
                    >
                      <button 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-6 items-stretch">
          {/* Left Placeholder (40%) */}
          <div className="lg:col-span-4 bg-white rounded-3xl border border-slate-200 shadow-xl flex flex-col items-center justify-center p-12 text-center h-[600px]">
          ...
          <div className="lg:col-span-6 bg-white rounded-3xl border border-slate-200 shadow-xl flex flex-col items-center justify-center p-12 text-center h-[600px]">
